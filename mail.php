...
<html lang="en">
	<head>
		<title>NK&N Store| Mail Us</title>
		<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					<h4>Address</h4>
					<p>81B, Federal housing Kado bimko,Abuja - Nigeria
					</p>
					<ul>
						<li>Telephone :+2347030235799</li>
						<li><a href="mailto:info@example.com">E-mail: nkiru.nnamdi@gmail.com</a></li>
					</ul>
				</div>
